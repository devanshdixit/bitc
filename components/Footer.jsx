            ...
            <div className="mt-4 pt-4 text-white">
                <div className="container mt-4 ">
                    ...
                    <div className="d-flex flex-wrap justify-content-center mt-3 mb-3">
                        <div className="p-2"><a href=""><img src="/images/social/instagram.svg" style={{ width: "2em", marginRight: ".5rem" }} alt="" /></a></div>
                        <div className="p-2"><a href=""><img src="/images/social/linkedin.svg" style={{ width: "2em", marginRight: ".5rem" }} alt="" /></a></div>
                        <div className="p-2"><img src="/images/social/telegram.svg" style={{ width: "2em", marginRight: ".5rem" }} alt="" /></div>
                        <div className="p-2"><a href=""><img src="/images/social/twitter.svg" style={{ width: "2em", marginRight: ".5rem" }} alt="" /></a></div>
                    ...
                    <div className="d-flex flex-wrap justify-content-center pb-4 pt-4 mt-3 mb-3">
                        ...
                        <div className="p-2 " style={{ marginLeft: "40px", marginRight: "40px" }}><a href="https://us-central1-unique-nuance-310113.cloudfunctions.net/policy">Privacy Policy</a></div>
                        <div className="p-2 mr-3">Community Guidelines</div>
                    </div>
                </div>
                <div className="container-fluid " style={{ backgroundColor: "#052634" }}>
                    <div className="text-center mt-4 pt-4 pb-4">@BITC. All rights Reserved</div>
                </div>
            </div>
        </footer>
    )
