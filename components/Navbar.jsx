...
const Header = () => {
    ...
    return (
        <Navbar collapseOnSelect expand="lg" bg="white" variant="light">
            <Container>
                <Navbar.Brand href="#home"><img src={`/images/bitc.jpeg`} className={styles.imgsize} alt="" /></Navbar.Brand>
                <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="me-auto">
                    </Nav>
                    <Nav className="ml-auto">
                        <Nav.Link href="#about" className={styles.headerlink} style={{ paddingLeft: ".8em" }}>About</Nav.Link>
                        <Nav.Link href="#services" className={styles.headerlink} style={{ paddingLeft: ".8em" }}>Services</Nav.Link>
                        <Nav.Link onClick={scrollto} className={styles.headerlink} style={{ paddingLeft: ".8em" }}>ContactUs</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
